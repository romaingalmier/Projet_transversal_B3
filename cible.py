...
def lancer_detection(choix_liste):
    #Temps de depart
    depart = time()
    duree = 3 #temps d'activation du programme 
    ...
    while time() - depart < duree:
        #Initialisation liste
        ListePaul1 = [False,0,0]
        ListePaul2 = [[False,False],[False,False]]
        ...
        if len(contours_viseur) > 0:
            ...
            ListePaul2[0][0] = ajuster_horiz
            ListePaul2[0][1] = sens_horiz
            ListePaul2[1][0] = ajuster_vertic
            ListePaul2[1][1] = sens_vertic
            if choix_liste == 2 :
                print (ListePaul2)
            ListePaul2.clear()
